...
<Modal {isOpen} size="lg">
    ...
    <ModalBody>
        ...
        <p>
            Below, you can see the exact payload that would get sent - nothing
            more.
        </p>
        ...
        <div class="row mt-4">
            ...
            <div class="col">
                ...
                {#if choice !== 'off'}
                    <HelpText>
                        Warpgate uses OpenPanel, which is an open-source
                        statistics platform. It is hosted in the EU, does not
                        store IP addresses and is GDPR compliant.
                    </HelpText>
                    <HelpText>
