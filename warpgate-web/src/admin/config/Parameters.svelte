                    ...
                    <SectionedForm>
                        ...
                        <Section id="ssh" title="SSH">
                            <Subsection title="Allowed authentication methods">
                                ...
                                <HelpText>
                                    Controls which authentication methods are
                                    offered to SSH clients. Disabling password
                                    authentication can help prevent brute-force
                                    attacks.
                                </HelpText>
                            </Subsection>
                            ...
                            <Subsection title="Quirks">
                                ...
                                <HelpText>
                                    Legacy SCP works over an exec channel and
                                    would be normally recorded like any other
                                    command. Disable to prevent SCP recordings
                                ...
                                <HelpText class="mt-3 mb-3">
                                    Optional message shown to SSH clients during
                                    authentication.
                                </HelpText>
                            </Subsection>
                        </Section>
                        ...
                        >
                            ...
                            <InfoBox class="mt-3 mb-3">
                                When enabled, authenticated users can request
                                user-tied, time-limited access tickets from
                                their profile page or via the API to a single
                                target.
                            </InfoBox>
                            ...
                            {#if parameters.ticketSelfServiceEnabled}
                                ...
                                <HelpText>
                                    When disabled, users only see targets they
                                    already have role-based access to.
                                </HelpText>
                                ...
                                <Subsection title="Limits">
                                    ...
                                    <HelpText>
                                        Global default. Can be overridden per
                                        target. Examples: 30m, 8h, 1d, 2h30m.
                                    </HelpText>
                        ...
                        <Section id="ui" title="UI">
                            ...
                            <HelpText>
                                ...
                                directly in the browser from the portal. When
                                off, only native-client connection instructions
                                are shown.
                            </HelpText>
                            ...
                            <HelpText>
                                ...
                                sessions, allowing users to log out or return
                        ...
                        {#if hasSsoProviders}
                            <Section id="login" title="Login">
                                ...
                                <HelpText>
                                    Minimized hides the username and password
                                    fields behind a link, with the focus on the
                                    SSO buttons. Disabled removes password login
                                    entirely and the server rejects password
                                    attempts — make sure all users can sign in
                                    via SSO first.
                                </HelpText>
                                ...
                                <HelpText>
                                    Forces users to sign in again once before
                                    accessing Web SSH or creating tickets if at
                                    least this much time has passed since
                                    they've logged in. Native SSH/database
                        ...
                        <Section id="login-protection" title="Login protection">
                            ...
                            <HelpText>
                                ...
                                settings below are preserved but not enforced.
                            </HelpText>
                            ...
                            {#if parameters.loginProtectionEnabled}
                                <Subsection title="IP rate-limit">
                                    ...
                                    <HelpText>
                                        ...
                                        period of <em>clean</em> activity — not
                                    ...
                                    <Subsection title="Lockout protection">
                                        ...
                                        <HelpText class="mb-3">
                                            Recommended: keeps an attacker from
                                            locking out an admin account by
                                            spamming its username. IP blocking
                                    ...
                                    <InfoBox>
                                        Manage active blocks &amp; lockouts on
                                        the
                                        <a
                        ...
                        >
                            <div class="d-flex align-items-center">
                                <div>
                                    Reporting: <strong>{analyticsLabel}</strong>
                                </div>
                                <Button
                                    class="ms-auto"
                                    color="secondary"
