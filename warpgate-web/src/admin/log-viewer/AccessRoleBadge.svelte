<script lang="ts">
    /**
     * Access role reference inside a log entry — screen 10.
     *
     * Chrome only: sveltestrap Badge and svelte-fa become ui/Badge and an
     * inline SVG. The link target and the warning tone are unchanged.
     */
...
<Badge
    tone="warning"
    href={id ? `#/config/access-roles/${id}` : undefined}
    class="wg-log-badge"
>
