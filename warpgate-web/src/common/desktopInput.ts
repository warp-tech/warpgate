...
export interface KeyPress { time: number, label: string }
export interface Click { time: number, x: number, y: number }
...
const KEYSYM_NAMES: Record<number, string> = {
    0x20: 'Space',
    0xff08: 'Backspace', 0xff09: 'Tab', 0xff0d: 'Enter', 0xff1b: 'Esc',
    0xff50: 'Home', 0xff51: '←', 0xff52: '↑', 0xff53: '→', 0xff54: '↓',
    0xff55: 'PgUp', 0xff56: 'PgDn', 0xff57: 'End', 0xff63: 'Insert', 0xffff: 'Delete',
    0xffe1: 'Shift', 0xffe2: 'Shift', 0xffe3: 'Ctrl', 0xffe4: 'Ctrl',
    0xffe5: 'CapsLock', 0xffe9: 'Alt', 0xffea: 'Alt', 0xffeb: 'Super', 0xffec: 'Super',
...
const SCANCODE_NAMES: Record<number, string> = {
    ...
    0x32: 'M', 0x33: ',', 0x34: '.', 0x35: '/', 0x36: 'Shift', 0x37: '*',
    0x38: 'Alt', 0x39: 'Space', 0x3a: 'CapsLock',
    ...
    0x47: 'Home', 0x48: '↑', 0x49: 'PgUp', 0x4b: '←', 0x4d: '→',
    0x4f: 'End', 0x50: '↓', 0x51: 'PgDn', 0x52: 'Insert', 0x53: 'Delete',
}
